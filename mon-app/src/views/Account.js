...
const Account = () => {
  ...
  const GameItem = ({status, id, infoPlayer}) => {
    ...
    return (
        <>
            <li onClick={() => handleClick()} className="bg-gray-200 p-1 px-2 flex justify-between">
                <p>
              <span className='idgame'>
                {
                    ...
                    <span>
                    / Status {status ? status : '(privé/public)'}
                  </span>
                </p>
                <span>
                    {
    ...
    return (
        <div>
                ...
                <div
                    ...
                    <div className="m-2">
                        <button
                            ...
                            className="bg-neutral-700 hover:bg-red-600 text-white text-3xl font-bold py-6 px-8 rounded-xl">Jouer
                        </button>
                    </div>
                    <Modal
                        openModal={listModal}
            ...
            description={
                alertMessage.length > 2 && <p className="text-medium text-red-800 font-bold text-center my-3">
                    {alertMessage}
                </p>
            }
                        children={<>
                ...
                <div>
                    <button onClick={() => setCreateModal(true)} type={"button"}
                            ...
                            <form>
                                ...
                                <div className="flex items-start mb-6">
                                    <div className="flex items-center h-5">
                                        <input onClick={() => setStatusCreation(!statusCreation)} id="remember"
                                               type="checkbox" value=""
